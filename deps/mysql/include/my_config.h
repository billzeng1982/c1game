...
#define DEFAULT_MYSQL_HOME "/usr/local/mysql-5.6.16"
#define SHAREDIR "/usr/local/mysql-5.6.16/share"
#define DEFAULT_BASEDIR "/usr/local/mysql-5.6.16"
#define MYSQL_DATADIR "/data/mysql"
#define DEFAULT_CHARSET_HOME "/usr/local/mysql-5.6.16"
#define PLUGINDIR "/usr/local/mysql-5.6.16/lib/plugin"
...
#define PACKAGE_STRING "MySQL Server 5.6.15"
#define PACKAGE_TARNAME "mysql"
#define PACKAGE_VERSION "5.6.15"
