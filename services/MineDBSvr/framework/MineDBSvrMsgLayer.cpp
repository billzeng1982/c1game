...
#include "LogMacros.h"
#include "../MineDBSvr.h"
#include "./MineDBSvrMsgLayer.h"



using namespace PKGMETA;

MineDBSvrMsgLayer::MineDBSvrMsgLayer() : CMsgLayerBase(sizeof(PKGMETA::SCPKG) * 2, sizeof(PKGMETA::SSPKG) * 2)
{
...
bool MineDBSvrMsgLayer::Init()
{
	m_pstConfig = &(MineDBSvr::Instance().GetConfig());
...
void MineDBSvrMsgLayer::_ForwardToWorkThread(MyTdrBuf* pstTdrBuf)
{
    assert(pstTdrBuf);
