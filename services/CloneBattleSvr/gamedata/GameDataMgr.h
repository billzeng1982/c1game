...
typedef TGameDataMgr<RESCLONEBATTLEPOOL>				ResCloneBattlePoolMgr_t;
...
private:
    ...
    DECL_INIT_RES_MGR(m_oResCloneBattlePoolMgr, "gamedata/ResData/server/clonebattle/ResCloneBattlePool.bytes");
	
private:
    DECL_GETTER_REF(ResBasicMgr_t, m_oResBasicMgr, ResBasicMgr);
    DECL_GETTER_REF(ResCloneBattlePoolMgr_t, m_oResCloneBattlePoolMgr, ResCloneBattlePoolMgr);
