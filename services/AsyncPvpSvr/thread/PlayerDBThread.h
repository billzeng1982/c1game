...
public:
	...
	void SendReqPkg(DT_ASYNC_PVP_PLAYER_DB_REQ& rstDBReq);

private:
    void SendRspPkg(DT_ASYNC_PVP_PLAYER_DB_RSP& rstDBRsp);
...
protected:
	...
	DT_ASYNC_PVP_PLAYER_DB_REQ     m_stReqPkg;
    DT_ASYNC_PVP_PLAYER_DB_RSP     m_stRspPkg;
};
