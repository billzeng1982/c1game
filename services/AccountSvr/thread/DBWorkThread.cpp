...
{        
    m_pstConfig = (ACCOUNTSVRCFG*)pvAppData;
    ...
    bool bRet = m_oAccountTable.CInit( ACCOUNT_TABLE_NAME, &m_oMysqlHandler, m_pstConfig);
    return bRet;
}
...
int CDBWorkThread::_HandleAccountSvrMsg()
{
    ...
    //IMsgBase* poMsgHandler = AccountSvrMsgLayer::Instance().GetMsgHandler( m_stSsRecvPkg.m_stHead.m_wMsgId );
