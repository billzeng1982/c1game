...
void InitDefault(va_list ap);
void SetVal(va_list ap, char *sP, char *sV);
int GetParamVal(char *sLine, char *sParam, char *sVal);
void Cfg_GetConfig(char *sConfigFilePath, ...);
