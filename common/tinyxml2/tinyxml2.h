...
XMLNode添加iChildNum用于指示child node的个数, billzeng 20120501
...
public:
	...
	*/
	...
	int GetChildNum() { return iChildNum; }
...
private:
	...
	//XMLAttribute* FindAttribute( const char* name ); --> declare as public, billzeng
