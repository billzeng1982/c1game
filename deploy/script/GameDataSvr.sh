...
#WorldData层级
AppWorldDataList=(app_FriendSvr.sh app_GuildSvr.sh app_AccountSvr.sh app_Log2DBSvr.sh app_MailDBSvr.sh app_MessageSvr.sh app_RoleSvr.sh  app_MiscSvr.sh app_AsyncPvpSvr.sh app_SerialNumSvr.sh app_MineDBSvr.sh)

StartAll=( ${AppWorldDataList[*]})
SvrNum=${#StartAll[*]}
ParaNum=$#
flag=$2
