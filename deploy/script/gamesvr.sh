...
#Cluster层级
AppClusterList=(app_ClusterGate.sh app_SdkDMSvr.sh app_DirSvr.sh app_ClusterSdkCbSvr.sh app_SerialNumSvr.sh app_ClusterAccountSvr.sh app_ClusterDBSvr.sh app_GuildExpeditionSvr.sh)
#WorldLogic层级
AppWorldLogicList=(app_MineSvr.sh app_ZoneConn.sh app_ZoneSvr.sh app_MailSvr.sh app_RankSvr.sh app_ReplaySvr.sh app_XiYouSDKSvr.sh app_LogQuerySvr.sh app_CloneBattleSvr.sh app_ZoneHttpConn.sh)
#WorldData层级
AppWorldDataList=(app_MineDBSvr.sh app_FriendSvr.sh app_GuildSvr.sh app_Log2DBSvr.sh app_MailDBSvr.sh  app_AccountSvr.sh app_MessageSvr.sh app_RoleSvr.sh app_SerialNumSvr.sh app_MiscSvr.sh app_AsyncPvpSvr.sh app_IdipAgentSvr.sh app_DataBackup.sh)

StartAll=(${AppFightList[*]} ${AppWorldLogicList[*]} ${AppWorldDataList[*]} ${AppClusterList[*]})
SvrNum=${#StartAll[*]}
ParaNum=$#
flag=$2
