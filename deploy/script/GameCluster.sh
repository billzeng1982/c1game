...
#Cluster层级                                                                                                                                                                                                     
AppClusterList=(app_ClusterGate.sh app_DirSvr.sh app_ClusterSdkCbSvr.sh app_SerialNumSvr.sh app_ClusterAccountSvr.sh)
#WorldLogic层级                                                                                                                                                                                                  
AppWorldLogicList=(app_ZoneConn.sh app_ZoneSvr.sh app_MailSvr.sh app_RankSvr.sh app_XiYouSDKSvr.sh app_CloneBattleSvr.sh app_IdipAgentSvr.sh)
#WorldData层级                                                                                                                                                                                                   
...
StartAll=(${AppFightList[*]} ${AppClusterList[*]})
SvrNum=${#StartAll[*]}
ParaNum=$#
flag=$2
